      ...
      .state('weekly-challenge', {
        ...
        templateProvider: function($timeout, $stateParams, $log, User) {
          ...
          return $timeout(function() {
            return "<ion-nav-view><iframe style='width:100vw;height:100vh' src='http://192.168.1.34:8062/#!/0429fb91-4f3c-47de-9adb-609996962188/" + User.getActiveProfileSync()._id + "/" + localStorage.getItem('Authorization') + "'></iframe></ion-nav-view>"
          }, 100);
        },
